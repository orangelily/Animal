...
public class PosValidationTest {
    ...
    public void pos_test_with_list_conflict()throws Exception{
        ...
        //返回冲突的id
        try {
            pos.readposList(list);
        }catch (ConfictException e){

            Assert.assertEquals( e.getMessage(),"e4e87cb2-8e9a-4749-abb6-26c59344dfee");
        }
    ...
    public void pos_test_without_list_conflict()throws Exception{
        ...
        PosValidation pos = new PosValidation();
        //无冲突,返回HashMap<String,String> posMap
        Assert.assertEquals(pos.readposList(list).size(),1);
    }
